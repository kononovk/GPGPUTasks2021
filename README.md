...
3. В тексте **PR** укажите вывод программы при исполнении на Travis CI и на вашем компьютере (в тройных кавычках, чтобы сохранить форматирование, см. [пример](/.github/pull_request_example.md)). И ваш бранч должен называться так же, как и у меня - **task00**.
